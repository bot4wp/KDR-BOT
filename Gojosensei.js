...
┃╠ ${prefix}report [bug]
┃╚═════════════✪
┗━━「 ${pushname} 」━⭓`,unicorn, [{"urlButton": {"displayText": "INSTAGRAM 📍","url": `${myweb}`}},{"urlButton": {"displayText": "WHATSAPP🔖","url": `${sc}`}},{"quickReplyButton": {"displayText": "🍜Donate🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "👤Owner👤","id": 'owner'}}] )
break
...
await GojoMdNx.send5ButImg(from, `` + '' + ' ', `
ALL CREDITS TO KHADHER -OWNER OF THE BOT`,unicorn, [{"urlButton": {"displayText": "INSTAGRAM📍","url": `${myweb}`}},{"urlButton": {"displayText": "WHATSAPP🔖","url": `${sc}`}},{"quickReplyButton": {"displayText": "🍜Donate🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "👤Owner👤","id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
